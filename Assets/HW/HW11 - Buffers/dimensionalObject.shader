Shader "Custom/dimensionalObject"
{
    Properties 
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float _gloss;
            float3 _ambientColor;
            float3 _worldLightPos0;
            float3 _worldLightColor0;
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 lightDirection = normalize(_worldLightPos0);
                float3 lightColor = _worldLightColor0; // includes intensity
                ...
                float3 blinnPhong = (diffuseFalloff * _surfaceColor * lightColor + specular + _ambientColor);
