Shader "examples/week 7/phong"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #define MAX_SPECULAR_POWER 256.0f
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 viewDir = normalize(viewPosition - i.worldPos);

                float3 lightRefDir = reflect(-lightDirection, normal);
                float specularFalloff = max(0, dot(viewDir, lightRefDir));
