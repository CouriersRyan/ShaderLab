    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag (Interpolators i) : SV_Target
            {
                ...
                float3 gradient = lerp (_colorLow, _colorHigh, smoothstep(0 , 1, pow(uv.y + _offset, _contrast)));
                float3 horizon = (1 - (2 * abs(0.5 - smoothstep(0 , 1, pow(uv.y + _offset, _contrast))))) * _colorHorizon;
