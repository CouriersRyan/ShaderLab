Shader "examples/week 5/vertex displacement"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // vert calculates it for each vertex, which varies by mesh but will generally always be less than fragment.
            ...
            // frag does calculations for each fragment (aka pixel). It can look better but less efficient.
