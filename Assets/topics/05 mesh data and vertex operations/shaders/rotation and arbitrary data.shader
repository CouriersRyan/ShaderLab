    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Interpolators vert (MeshData v)
            {
                ...
                float4x4 x = rotation_matrix(float3(1, 0 ,0), _rotX * TAU * o.color);
                float4x4 y = rotation_matrix(float3(0, 1 ,0), _rotY * TAU * o.color);
                float4x4 z = rotation_matrix(float3(0, 0 ,1), _rotZ * TAU * o.color);
                float4x4 rot = mul(mul(x, z), y);
